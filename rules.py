...
def total_revenue(data: dict, financial_index):
    ...
    net_revenue = pnl.get("lineItems").get("net_revenue")
    return net_revenue
...
def total_borrowing(data: dict, financial_index):
    ...
    financial = data.get("financials")[financial_index]
    bs = financial.get("bs")
    long_term_borrowings = bs.get("liabilities").get("long_term_borrowings")
    short_term_borrowings = bs.get("liabilities").get("short_term_borrowings")
...
def iscr(data: dict, financial_index):
    ...
    pnl = financial.get("pnl")
    bs = financial.get("bs")
    profit_before_interest_and_tax = pnl.get("lineItems").get(
        "profit_before_interest_and_tax"
    )
    depreciation = pnl.get("lineItems").get("depreciation")
    interest_expenses = pnl.get("lineItems").get("interest")
